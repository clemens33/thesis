...
PATH = "./23/cb8eec391911402d9d28de5017d0edeb/checkpoints/epoch=85-step=171.ckpt"
INIT_SEED = 1
TRIALS = 50
...
def main():
    ...
    mlf_logger = MLFlowLogger(
        experiment_name="bbbp_test1",
        tracking_uri="https://mlflow.kriechbaumer.at"
    )

    classifier = TabNetClassifier.load_from_checkpoint(PATH)
    classifier.eval()
